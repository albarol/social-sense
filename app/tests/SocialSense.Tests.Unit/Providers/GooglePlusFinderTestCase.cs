...
namespace SocialSense.Tests.Unit.Providers
{
    ...
    public class GooglePlusFinderTestCase
    {
        private readonly IFinder finder;

        public GooglePlusFinderTestCase()
        {
            this.finder = Engine.GooglePlus ();
        }

        [Test]
        public void Search_VerifyIfGooglePlusReturnSomeResult()
        {
